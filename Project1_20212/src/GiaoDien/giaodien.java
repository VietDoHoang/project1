...
import Quan_ly_khach_san.GiaoDienQuanLyKhachSan;
...
public class giaodien {
	...
	private void initialize() {
		frame = new JFrame("Đỗ Hoàng Việt - 20198272");
		...
		choice.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if(choiceTmp.getSelectedItem()==choice.getItem(0)) {
				...
				}else if(choiceTmp.getSelectedItem()==choice.getItem(3)) {
					choice_1.removeAll();
					choice_1.add("Bai1");
					choice_1.add("Bai2");
					choice_1.add("Bai3");
					...
					choice_1.removeAll();
					choice_1.add("Quan Ly Khach San");
				}
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(choice.getSelectedItem().equalsIgnoreCase("Bai tap tuan 31") && choice_1.getSelectedItem().equalsIgnoreCase("bai1")) {
					DeBai.setText("Cho một dãy số tự nhiên, viết chương trình sắp xếp dãy này theo thứ tự giảm dần.(Mỗi số cách nhau bằng khoảng trắng)");
					Input.setText(null);
					Output.setText(null);
				}else if(choice.getSelectedItem().equalsIgnoreCase("Bai tap tuan 31") && choice_1.getSelectedItem().equalsIgnoreCase("bai2")) {
					DeBai.setText("Cho dãy số tự nhiên, in ra màn hình tất cả các số nguyên tố của dãy này.(Mỗi số cách nhau bằng khoảng trắng)");
					Input.setText(null);
					Output.setText(null);
					
				}else if(choice.getSelectedItem().equalsIgnoreCase("Bai tap tuan 31") && choice_1.getSelectedItem().equalsIgnoreCase("bai3")) {
					DeBai.setText("Cho một dãy các số tự nhiên, tìm và in ra 1 giá trị min của dãy này và tất cả các chỉ số ứng với giá trị min này.(Mỗi số cách nhau bằng khoảng trắng)");
					Input.setText(null);
					Output.setText(null);
					...
					DeBai.setText("Cho một dãy số, hãy in ra hạng của dãy trên thỏa mãn: số này là ước số thực sự của 1 số hạng khác trong dãy trên.(cách nhau bằng khoảng trắng)");
					Input.setText(null);
					Output.setText(null);
				}
				// Tuần 32
				...
				if(choice.getSelectedItem().equalsIgnoreCase("Bai tap tuan 33") && choice_1.getSelectedItem().equalsIgnoreCase("Quan Ly Khach San")) {
					GiaoDienQuanLyKhachSan qlks = new GiaoDienQuanLyKhachSan();
					qlks.frame1.setVisible(true);
		...
		Button button_1 = new Button("chạy");
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(choice.getSelectedItem().equalsIgnoreCase("Bai tap tuan 31") && choice_1.getSelectedItem().equalsIgnoreCase("bai1")) {
					...
					String input = Input.getText();
					if(input.isEmpty()) {
						JOptionPane.showMessageDialog(frame,"Nhập dãy số");
					}
					...
					String input = Input.getText();
					if(input.isEmpty()) {
						JOptionPane.showMessageDialog(frame,"Nhap dãy số");
					}
					String[] arr =  input.split(" ");
					int[] values = Arrays.stream(arr)
	                        .mapToInt(Integer::parseInt)
					...
					for(int i=arr.length-1;i>=1;i--) {
						for(int j=i-1;j>=0;j--) {
							if(x.checkHopSo(values[j])==false && values[j]!=values[i] && values[i]%values[j]==0) {
								n.add(values[j]);
							}
						}
					}
					bai6 chuyenso = new bai6();
					Output.setText(chuyenso.arrayListLoaiSoTrungLap(n)+"");
				}
				// Tuần 32
				if(choice.getSelectedItem().equalsIgnoreCase("Bai tap tuan 32") && choice_1.getSelectedItem().equalsIgnoreCase("bai1")) {
					DeBai.setText("Cho trước 1 xâu ký tự là họ tên người đầy đủ nhưng khi nhập có thể thừa một số dấu cách. Hãy xóa đi các dấu cách thừa và in ra họ tên chính xác.");
					String input = Input.getText();
					if(input.isEmpty()) {
						JOptionPane.showMessageDialog(frame,"Nhập xâu");
					}
